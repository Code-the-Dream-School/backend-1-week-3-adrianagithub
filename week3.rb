...
fname = gets.chomp # this returns a string 
arrayname << fname
puts "Enter your middle name" 
mname = gets.chomp # this returns a string 
arrayname << mname
puts "Enter your last name" 
lname = gets.chomp # this returns a string 
arrayname << lname
puts "Greetings #{arrayname} nice to meet you I love your name #{arrayname}."
...
#(4) Write a program, leap_year.rb. It will ask the user for a starting year and an ending year, and it will then print out all the leap years between them, including the starting or ending year if those are 
#leap years. The rules for leap years are: A leap year is divisible by 4, except for years that are divisible by 100 -- those aren't leap years -- except for years that are divisible by 400, which ARE leap years.
